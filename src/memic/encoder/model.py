import numpy as np
import torch
from memic.encoder.params_data import mel_n_channels
from memic.encoder.params_model import model_embedding_size, model_hidden_size, model_num_layers
...
class SpeakerEncoder(nn.Module):
    def __init__(self, device, loss_device):
        ...
        # Network defition
        self.lstm = nn.LSTM(input_size=mel_n_channels, hidden_size=model_hidden_size, num_layers=model_num_layers, batch_first=True).to(
            device
        )
